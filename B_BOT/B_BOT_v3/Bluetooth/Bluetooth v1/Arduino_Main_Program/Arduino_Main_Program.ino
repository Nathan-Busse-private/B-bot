...
const int rxpin = 2;       //Bluetooth serial stuff
const int txpin = 3;
...
#define Kp  50 //Set this first
#define Kd  3 //Set this secound
#define Ki  255 //Finally set this

#define RKp  50 //Set this first
#define RKd 3//Set this secound
#define RKi  255 //Finally set this
...
void setup() {
  ...
  originalSetpoint = 172.5;  //consigne
  yoriginalSetpoint = 172.5;
